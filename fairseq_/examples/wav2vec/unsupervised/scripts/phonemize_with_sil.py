...
def main():
    ...
    for line in sys.stdin:
        ...
        # Keep only words covered by the lexicon.  Long wiki lines often mix
        # rare tokens / punctuation; requiring *every* token to match produced
        # zero output and empty lm.phones.filtered.txt (breaks GAN mmap load).
